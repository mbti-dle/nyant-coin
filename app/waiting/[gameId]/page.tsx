...
const WaitingPage = ({ params }) => {
  ...
  return (
    <main className="relative flex h-screen min-h-dvh w-full items-center justify-center overflow-auto bg-sea-spaceship-mobile bg-cover bg-fixed bg-top md:bg-sea-spaceship-desktop">
      <div className="absolute bottom-[284px] mt-6 flex min-h-96 flex-col items-center justify-between">
        <PlayerGrid />
